...
struct thread
  {
    ...
    int original_priority;              //for priority donation chnages  done
    bool is_donated;
    struct list acquired_locks;
    struct lock * blocked_by_lock;      // changes end for priority donation
...
void thread_set_priority_donation(struct thread * , int, bool );
